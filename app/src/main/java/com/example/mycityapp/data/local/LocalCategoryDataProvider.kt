...
object LocalCategoryDataProvider {
    ...
    val rootCategoriesSubItems = listOf<Category>(
        Category(
            rootCategory = R.string.category_transportation,
        ...
        Category(
            rootCategory = R.string.category_bridge,
        ...
        Category(
            rootCategory = R.string.category_park,
        ...
        Category(
            rootCategory = R.string.category_attraction,
